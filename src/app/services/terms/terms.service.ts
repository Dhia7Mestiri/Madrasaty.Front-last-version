...
import * as consts from '@consts/global.const';
...
export class PeriodicityService {
  ...
  getPeriodicitiesBySchoolYear(id: number) {
    return this.http.get<Periodicity[]>(consts.PERIODICITY_URL + id, this.httpOptions)
  }

  getPeriodicitiesByActifSchoolYear()
  {
    return this.http.get<Periodicity[]>(consts.PERIODICITY_URL+"Actif", this.httpOptions)
  }
  createPeriodicity(periodicity: Periodicity): Observable<Periodicity> {
    return this.http.post<Periodicity>(consts.PERIODICITY_URL, periodicity, this.httpOptions)
  }
  deletePeriodicity(id: number): Observable<Periodicity> {
    return this.http.delete<Periodicity>(consts.PERIODICITY_URL + id, this.httpOptions)
  }
