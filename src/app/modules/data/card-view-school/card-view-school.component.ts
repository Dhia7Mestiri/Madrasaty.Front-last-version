...
@Component({
    selector   : 'app-card-view-school',
    templateUrl: './card-view-school.component.html',
    styleUrls  : ['./card-view-school.component.scss']
})
export class CardViewSchoolComponent implements OnInit
{
