...
@Component({
    selector   : 'app-card-view-member',
    templateUrl: './card-view-member.component.html',
    styleUrls  : ['./card-view-member.component.scss']
})
export class CardViewMemberComponent implements OnInit
{
