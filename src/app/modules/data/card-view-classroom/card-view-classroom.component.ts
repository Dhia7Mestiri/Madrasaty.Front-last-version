...
@Component({
    selector   : 'app-card-view-classroom',
    templateUrl: './card-view-classroom.component.html',
    styleUrls  : ['./card-view-classroom.component.scss']
})
export class CardViewClassroomComponent implements OnInit
{
