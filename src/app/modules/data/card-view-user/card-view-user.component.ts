...
@Component({
    selector   : 'app-card-view-user',
    templateUrl: './card-view-user.component.html',
    styleUrls  : ['./card-view-user.component.scss']
})
export class CardViewUserComponent implements OnInit
{
