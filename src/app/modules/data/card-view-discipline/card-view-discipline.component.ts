...
@Component({
    selector   : 'app-card-view-discipline',
    templateUrl: './card-view-discipline.component.html',
    styleUrls  : ['./card-view-discipline.component.scss']
})
export class CardViewDisciplineComponent implements OnInit
{
    @Input() useCustomHTML = false;
